...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(view ->
                Snackbar.make(view, "Goto NonAppCompatActivity", Snackbar.LENGTH_LONG)
                        .setAction("Action", v -> startActivity(new Intent(MainActivity.this, NonAppCompatActivity.class)))
                        .show()
        );
